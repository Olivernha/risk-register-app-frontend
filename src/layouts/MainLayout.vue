...
const navigationItems = computed(() => {
  ...
  // Always show My Actions for all users - they'll see it if they have assigned mitigations
  // The view itself will handle showing empty state if no assignments
  items.push({
    to: '/my-actions',
    title: 'My Actions',
    icon: h('svg', { class: 'w-5 h-5', fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor' }, [
